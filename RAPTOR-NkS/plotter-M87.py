...
rapplot.plot_data_stokes_mesh(image,min,max,stokes_ind,data_id,fig,axs[0][0],Npix,halfrange,mas,label="Stokes I",cmap="afmhot",scale='lin')
rapplot.plot_data_stokes_mesh(image,min,max,1,data_id,fig,axs[1][0],Npix,halfrange,mas,label="Stokes Q",cmap="RdBu")
rapplot.plot_data_stokes_mesh(image,min,max,2,data_id,fig,axs[0][1],Npix,halfrange,mas,label="Stokes U",cmap="RdBu")
rapplot.plot_data_stokes_mesh(image,min,max,3,data_id,fig,axs[1][1],Npix,halfrange,mas,label="Stokes V",cmap="RdBu")
